...
String getStatusJSON() {
  return "{\"type\": \"status\", \"data\" : { \"temp\": \"" + String(tubState.tubTemp,1) + "\", \"heater\": " + (tubState.heaterState ? "true" : "false") + ", \"light\": " + (tubState.lightState ? "true" : "false") + ", \"mode\": \""+tubMode.getCurrentState()+"\", \"uptime\": " + lastUptime + ", \"state\": \"" + tubState.state + "\" } }";
}
